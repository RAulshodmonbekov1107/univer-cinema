...
SECRET_KEY = 'django-insecure-fy*tq5_f#nu+qpa%o1tn#%-5nfg$x=ja3vd_l4+p&y4r07b-wt'
...
# For development we'll use SQLite, but in production use PostgreSQL
DATABASES = {
    'default': {
...
TIME_ZONE = 'Asia/Bishkek'  # Using Kyrgyzstan timezone
